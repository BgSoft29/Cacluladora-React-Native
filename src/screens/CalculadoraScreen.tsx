...
export const CalculadoraScreen = () => {
    ...
    const { numeroAnterior, numero, limpiar, positivoNegativo, btnDelete, botonDividir, botonMultiplicar, botonRestar, botonSumar, armarNumero, calcular } = useCalculadora();
